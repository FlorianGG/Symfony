...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b5edbada99d8029de1c12a7a847a564fad341fd9ce50496d1b87e409a477c555');
        return $instance;
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('florian.prof@gmail.com');
        $a->setPassword('Fg164191!');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('23424f07c8b36c485066c1eb205bab695084cd1b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59808a87a48545.12273569')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'florian.prof@gmail.com',
            'mailer_password' => 'Fg164191!',
            'secret' => '23424f07c8b36c485066c1eb205bab695084cd1b',
            'nb_per_page' => 3,
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '23424f07c8b36c485066c1eb205bab695084cd1b',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'florian.prof@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Fg164191!',
